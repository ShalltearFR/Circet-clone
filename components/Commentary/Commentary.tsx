...
const Commentary: React.FC<CommentaryProps> = ({
  ...
  return (
    <div className="bg-commentary p-8 flex flex-col rounded-xl mx-auto items-center big-tablet:px-8 big-tablet:max-w-[620px] big-tablet:flex-row big-tablet:rounded-full">
      <div className="mb-5 big-tablet:mb-0 flex-shrink-0 relative ">
        <img src="/img/Candidats/quotes.png" className="absolute left-20 bottom-28"/>
        <img src="/img/Candidats/youtube.png" className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20"/>
      ...
      <div className="big-tablet:ml-3 laptop:ml-7">
        ...
        <div className="text-sm">
          ...
          <span className="font-bold">{source.job}</span>
        </div>
